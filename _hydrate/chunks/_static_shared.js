...
`),Zr=()=>{lt.global(Be(`
      ...
      ${z(["hr:after"],{...c.separator,content:'"\u273B \u273B \u273B"',display:"block",letterSpacing:"0.5em",textAlign:"center"})}
      ...
      ${z(["code"],{...c.code,borderRadius:"0.1875rem",display:"inline-flex",fontSize:"0.875em",hyphens:"auto",lineHeight:"1.5em",overflowWrap:"break-word",padding:"0.1111rem 0.3333rem 0",wordWrap:"break-word"})}
      ...
      ${z(["a"],{...c.links,fontWeight:"bolder"})}

      ${z(["abbr"],{...c.abbreviation,textDecoration:"none"})}

      ${z(["aside","small"],c.deemphasize)}

      ${z(["aside"],{...c.aside,fontSize:"0.8889em",margin:"1rem 0",padding:"0.8889rem","& p":{lineHeight:1.3333}})}
      ...
      ${c.darkMode} {
        ${z(["body"],{...c[c.darkMode].document,...c[c.darkMode].prose})}
        ...
        ${z($t,c[c.darkMode].emphasize)}
        ${z(["pre"],c[c.darkMode].pre)}
        ${z(["code"],c[c.darkMode].code)}
        ${z(["a"],c[c.darkMode].links)}
        ${z(["aside","small"],c[c.darkMode].deemphasize)}
        ${z(["aside"],c[c.darkMode].aside)}
        ${z(["hr:after"],c[c.darkMode].separator)}
      }
    `))},Qr=`
  ${c.mainGridColumns[0]}
  ${c.mainGridColumns[1]}
