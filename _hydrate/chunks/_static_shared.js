...
Check http://fela.js.org/docs/basics/Rules.html#styleobject for more information.`);else{const g=io(d,m,r,s,a);if(!e.cache.hasOwnProperty(g)){if(ro(m)){e.cache[g]={className:""};continue}const y=lo(d,m),h=ze(g),b=e.devMode?xo(d,m,r,s,a,h):(e.selectorPrefix||"_")+h.slice(0,8),p=so(b,r),x={type:ao,className:b,selector:p,declaration:y,pseudo:r,media:s,support:a};e.cache[g]=x,e._emitChange(x)}const f=e.cache[g].className;f&&(l+=` ${f}`)}}return l},e)}import.meta.env=ce;const de=De.createRequire(import.meta.url),{default:wo}=de("fela-identifier"),{default:$o}=de("fela-plugin-embedded"),{default:Mo}=de("fela-plugin-multiple-selectors"),{default:Oo}=de("fela-plugin-typescript"),We=Ve==="development",Ee=wo(),Z=Zt({devMode:We,enhancers:[Eo(),Ee],plugins:[$o(),Mo(),Oo()]});!We&&import.meta.url.endsWith("/.microsite/staging/src/lib/styles/styles.js")&&Z.subscribe(async()=>{Jt(Z)});const Ao=e=>Array.isArray(e)?e:[e],me=({children:e})=>o(Gt,{renderer:Z},...Ao(e)),Po=e=>e,Lo=e=>Z.renderRule(Po,e),v=Object.assign(Lo,{global:Z.renderStatic.bind(Z)}),c=(e,t)=>{const n=typeof t=="function"?t:()=>t;return zt(n,e,Object.keys)},ie=Symbol("DEFAULT_TOPIC"),u={[ie]:ie,ABLEISM:"Ableism",ART:"Art",LEMON:"My puppy",MENTAL_ILLNESS:"Mental illness",NEURODIVERGENCE:"Neurodivergence",PHILOSOPHY:"Philosophy",POLITICS:"Politics",RACISM:"Racism",SEXISM:"Sexism",SUBSTANCE_ABUSE:"Substance use & abuse",TECHNOLOGY:"Technology",TRANSPHOBIA:"Transphobia"},jo=e=>typeof e=="string"||typeof e=="symbol",Ke=e=>jo(e)&&e in u,qe=e=>Ke(e)?u[e]:e,Ze=Object.entries(u).reduce((e,t)=>{const[n,r]=t;return typeof n=="string"?{...e,[r]:n}:e},{}),Io=e=>Ke(e)?e:Ze[e],Bo=e=>e.toLowerCase().replace(/\W+|_+/g,"-"),Ro=Object.fromEntries(Object.entries(Ze).map(([e,t])=>typeof t=="string"?[e,Bo(t)]:null).filter(e=>e!=null)),No=e=>{const t=qe(e);if(typeof t=="string")return Ro[t]},ge=2,we={minEm:1.0625,fluidVw:1.0625*ge,maxEm:1.325},w="@media (prefers-color-scheme: dark)",Ho=["h1","h2","h3","h4","h5","h6"],Do=["dd","dl","dt","li","ol","ul"],_o=[...Ho,...Do,"p"],J=we.minEm/we.maxEm,I={h1:1.953,h2:1.563,h3:1.25},Fo={h1:{minEm:I.h1*J,fluidVw:I.h1*J*ge,maxEm:I.h1},h2:{minEm:I.h2*J,fluidVw:I.h2*J*ge,maxEm:I.h2},h3:{minEm:I.h3*J,fluidVw:I.h3*J*ge,maxEm:I.h3}},Je=75,pe=1.25,zo=["0.7fr",`${pe}rem`,[`${Je}ch`,`calc(100% - ${pe*2}rem)`],`${pe}rem`,"1.2fr"],$e=1,Go=["0.7fr",`${$e}rem`,[`${Je*1.1875}ch`,`calc(100% - ${$e*2}rem)`],`${$e}rem`,"1.2fr"],Xo=['"Consolas"','"Bitstream Vera Sans Mono"','"Courier New"',"Courier","monospace"],Qe=Xo.join(", "),Yo=["system-ui","-apple-system","BlinkMacSystemFont","Segoe UI","Roboto","Helvetica Neue","Arial","Noto Sans","sans-serif","Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji"],Uo=Yo.map(e=>e.includes(" ")?`"${e}"`:e).join(", "),k={DEFAULT_TOPIC:{dark:"#aaa",light:"#555"},ABLEISM:"#edc258",ARTS_CRAFTS:"#293fe4",LEMON:"#82c2e4",MENTAL_ILLNESS:"#d33d0a",NEURODIVERGENCE:"#f7834a",PHILOSOPHY:"#9a9aa6",POLITICS:"#ffe413",RACISM:"#7a5221",SEXISM:"#ec9ac0",SUBSTANCE_ABUSE:"#edbb0e",TECHNOLOGY:"hsla(336deg, 100%, 42%, 0.9)",TRANSPHOBIA:"#10be8a"},Vo="hover-inherit-topic-color",Wo=[[u[ie],v({"&, &.hover-inherit-topic-color:hover":{color:k.DEFAULT_TOPIC.light},[w]:{"&, &.hover-inherit-topic-color:hover":{color:k.DEFAULT_TOPIC.dark}}})],[u.ABLEISM,v({"&, &.hover-inherit-topic-color:hover":{color:k.ABLEISM}})],[u.ART,v({"&, &.hover-inherit-topic-color:hover":{color:k.ARTS_CRAFTS}})],[u.LEMON,v({"&, &.hover-inherit-topic-color:hover":{color:k.LEMON}})],[u.MENTAL_ILLNESS,v({"&, &.hover-inherit-topic-color:hover":{color:k.MENTAL_ILLNESS}})],[u.NEURODIVERGENCE,v({"&, &.hover-inherit-topic-color:hover":{color:k.NEURODIVERGENCE}})],[u.PHILOSOPHY,v({"&, &.hover-inherit-topic-color:hover":{color:k.PHILOSOPHY}})],[u.POLITICS,v({"&, &.hover-inherit-topic-color:hover":{color:k.POLITICS}})],[u.RACISM,v({"&, &.hover-inherit-topic-color:hover":{color:k.RACISM}})],[u.SEXISM,v({"&, &.hover-inherit-topic-color:hover":{color:k.SEXISM}})],[u.SUBSTANCE_ABUSE,v({"&, &.hover-inherit-topic-color:hover":{color:k.SUBSTANCE_ABUSE}})],[u.TECHNOLOGY,v({"&, &.hover-inherit-topic-color:hover":{color:k.TECHNOLOGY}})],[u.TRANSPHOBIA,v({"&, &.hover-inherit-topic-color:hover":{color:k.TRANSPHOBIA}})]],Ko=Object.fromEntries(Wo),et=Ee(),i={HOVER_INHERIT_TOPIC_COLOR_CLASS_NAME:Vo,baseFontSizeRange:we,darkMode:w,aside:{backgroundColor:"hsl(53deg, 81%, 96%)",color:"hsl(212deg, 10%, 35%)",nested:{"& > h1":{color:"hsl(53deg, 13%, 26%)"},[w]:{backgroundColor:"hsl(130deg,21%,14%)",color:"hsl(212deg, 3%, 80%)",nested:{"& > h1":{color:"hsl(130deg, 6%, 90%)"}}}}},blog:{listing:{descriptionIdentifier:et,description:{color:"hsl(212deg, 10%, 35%)",fontSize:"0.9375em",nested:{[w]:{color:"hsl(212deg, 10%, 75%)"}}},itemAlt:{backgroundColor:"hsl(192deg, 15%, 97%)",nested:{"& h2":{backgroundColor:"hsla(192deg, 15%, 97%, 0.75)"},[`& .${et}`]:{color:"hsl(212deg, 10%, 20%)",nested:{[w]:{color:"hsl(212deg, 10%, 90%)"}}},[w]:{backgroundColor:"hsl(192deg, 45%, 3%)",nested:{"& h2":{backgroundColor:"hsla(192deg, 45%, 3%, 0.75)"}}}}},linkTitle:{backgroundColor:"hsla(192deg, 85%, 99%, 0.75)",color:"#000",nested:{":hover":{color:"#000"},[w]:{backgroundColor:"hsla(192deg, 10%, 10%, 0.75)",color:"#fff",":hover":{color:"#fff"}}}}}},document:{backgroundColor:"hsl(192deg, 85%, 99%)"},code:{backgroundColor:"hsl(220deg, 10%, 94%)",color:"hsla(210deg, 12%, 0%, 95%)",fontFamily:Qe},codeBlock:{symbol:{color:"hsl(228deg, 5%, 81%)",fontFamily:Qe,nested:{[w]:{color:"hsl(228deg, 6%, 21%)"}}}},deemphasize:{color:"hsl(212deg, 10%, 35%)",fontSize:"0.9375em"},emphasize:{color:"#000"},firstLastMarginZeroElements:_o,headingRanges:Fo,[w]:{code:{backgroundColor:"hsl(220deg, 10%, 20%)",color:"hsla(210deg, 12%, 100%, 95%)"},document:{backgroundColor:"hsl(192deg, 10%, 10%)"},deemphasize:{color:"hsl(212deg, 10%, 75%)"},emphasize:{color:"#fff"},links:{"&:hover":{color:"hsl(205deg, 76%, 70%)"},"&, &:active, &:visited, & code":{color:"hsl(205deg, 56%, 70%)",textDecorationColor:"hsla(205deg, 56%, 70%, 50%)"}},pre:{color:"hsla(210deg, 12%, 100%, 90%)",backgroundColor:"#000",outline:"none"},prose:{color:"hsl(210deg, 10%, 90%)"},siteHeader:{pageLinks:{color:"#fff","&:active, &:focus, &:hover":{color:"#f9f9f9"},":visited":{color:"#fff"}}},siteLogo:{color:"hsl(336deg, 100%, 95%)"}},links:{"&:hover":{color:"hsl(205deg, 78%, 41%)",textDecorationColor:"initial"},"&, & code":{color:"hsl(205deg, 86%, 31%)",textDecorationColor:"hsla(205deg, 86%, 31%, 50%)"}},mainGridColumns:zo,mainGridSidePaddingRem:pe,pre:{color:"hsl(210deg, 12%, 16%)",backgroundColor:"#fff",outline:"1px solid #eee"},prose:{color:"hsla(210deg, 12%, 5%, 95%)",fontFamily:Uo},siteHeader:{columns:Go,pageLinks:{color:"#000","&:active, &:focus, &:hover":{color:"#0a0a0a"},":visited":{color:"#000"}}},siteLogo:{color:"hsl(336deg, 100%, 42%)"},topicColorClassNames:Ko,topicTagIdentifier:Ee(),topicTagInner:{backgroundImage:q(`linear-gradient(
      ...
      rgba(255, 255, 255, 0.95) 2px
        ...
        )`)},[`& .${e}, &:hover .${e}`]:{color:"#000"},[w]:{nested:{[[`&:active .${e}`,`&:focus .${e}`,`&:hover .${e}`].join(",")]:{backgroundImage:q(`linear-gradient(
              to top,
              rgba(0, 0, 0, 0.7),
              rgba(0, 0, 0, 0.75) 2px
...
`),Qo=()=>{v.global(q(`
      ...
      ${C(["code"],{...i.code,borderRadius:"0.1875rem",display:"inline-block",fontSize:"0.875em",hyphens:"auto",lineHeight:"1.5em",overflowWrap:"break-word",padding:"0.25rem 0.375rem 0",wordWrap:"break-word",nested:{"&:first-line":{verticalAlign:"-0.5em"}}})}
      ...
      ${C(["a"],{...i.links,fontWeight:"bolder"})}

      ${C(["aside","small"],i.deemphasize)}
      ...
      ${i.darkMode} {
        ${C(["body"],{...i[i.darkMode].document,...i[i.darkMode].prose})}
        ...
        ${C(tt,i[i.darkMode].emphasize)}
        ${C(["pre"],i[i.darkMode].pre)}
        ${C(["code"],i[i.darkMode].code)}
        ${C(["a"],i[i.darkMode].links)}
        ${C(["aside","small"],i[i.darkMode].deemphasize)}
      }
    `))},en=`
  ${i.mainGridColumns[0]}
  ${i.mainGridColumns[1]}
  ...
  ${i.mainGridColumns[3]}
  ${i.mainGridColumns[4]}
`.replace(/\s+/g," "),ot={gridColumn:"1 / -1"},nt=v(ot),B=c("div",{nested:{[`& > .${nt}`]:{gridColumn:"1 / -1"},"& > *":{gridColumn:"3 / 3"},"& > details":{marginTop:0},"& > h1":{marginTop:0},"& > h2":{marginTop:0},"& > h3":{marginTop:0},"& > ol":{marginTop:0},"& > p":{marginTop:0},"& > ul":{marginTop:0}},display:"grid",gridTemplateColumns:en,...ot}),tn=c(B,{margin:"1rem 0 2rem",maxWidth:"100%",padding:0,width:"auto"}),it=c("div",{alignContent:"flex-start",alignItems:"flex-start",display:"flex",gridColumn:"2 / 5"}),on=c("div",{flexGrow:0,fontSize:"9em",height:0,lineHeight:"3.5rem",overflow:"visible",textAlign:"center",transform:"rotate(-6.5deg)",userSelect:"none",width:"3.75rem"}),nn=c("div",{flexGrow:1,padding:"1rem 0.75rem"}),Me="div",rn={ContentContainer:Me,InnerContainer:it,OuterContainer:Me,SymbolContainer:Me},sn=e=>{const{children:t,ContentContainer:n,InnerContainer:r,OuterContainer:s,outerContainerProps:a,symbol:l,SymbolContainer:d}={...rn,...e};return o(tn,{as:s,...a},o(it,{as:r},o(on,{as:d,role:"presentation"},l),o(nn,{as:n},t)))},an=c("pre",{fontSize:"1rem"}),ln=c("div",{gridColumn:"2 / 6"}),cn=c(B,{...i.pre,nested:{[i.darkMode]:{...i[i.darkMode].pre},"& code":{backgroundColor:"transparent"},"& pre":{backgroundColor:"transparent",maxWidth:"100%",margin:0,overflow:"auto",outline:"none",padding:["1rem","0"].join(" ")}}}),dn=c("div",{...i.codeBlock.symbol,fontSize:K("3.2em","10vw","4.5em"),marginTop:"-0.325em",textIndent:"-0.25em"}),mn=({children:e})=>o(sn,{ContentContainer:an,InnerContainer:ln,OuterContainer:cn,symbol:"{",SymbolContainer:dn},e),gn=e=>typeof e=="object"&&e!=null,pn=c("span",{display:"inline-block",fontSize:"1.5em",fontStyle:"normal",lineHeight:.5,padding:"0 0.125em",verticalAlign:"-0.125em"}),hn=(e,t)=>gn(e)&&e.role==="img"&&typeof e["aria-label"]=="string"&&typeof t=="string"&&Xt().test(t),un=({["aria-label"]:e,children:t,role:n})=>o(pn,{"aria-label":e,role:n},t),rt=W.resolve(process.cwd(),"./syntax-themes"),[fn,yn]=await Promise.all([Ge(W.resolve(rt,"./yi-dark.json")),Ge(W.resolve(rt,"./yi-light.json"))]),bn={background:"backgroundColor",fontStyle:"fontStyle",foreground:"color"},Sn={bold:{fontWeight:"bold"},italic:{fontStyle:"italic"},strikethrough:{textDecoration:"strikethrough"},underline:{textDecoration:"underline"}},vn=e=>e.trim().split(/\b\W*\b/).reduce((t,n)=>({...t,...Sn[n]}),{}),st=e=>Object.entries(e).reduce((t,[n,r])=>{const s=bn[n];if(r==null||typeof s!="string")return t;const a=s==="fontStyle"?vn(r):{[s]:r};return{...t,...a}},{}),[Cn,at]=await Promise.all([Xe({theme:fn}),Xe({theme:yn})]),kn=new Set([...mo,...go,...po]),xn=new Set(["ts","tsx","typescript"]),Tn=(e,t)=>{const[n,r]=[at,Cn].map(s=>s.codeToThemedTokens(e,t).reduce((l,d)=>d.reduce((m,g)=>({...m,...g.explanation?.reduce((f,y)=>({...f,...y.scopes.reduce((h,{themeMatches:b})=>({...h,...b.reduce((p,{name:x,scope:A,settings:N})=>({...p,byName:x==null?p.byName:{...p.byName,[x]:N},byScope:Array.isArray(A)?{...p.byScope,...A.reduce((R,H)=>({...R,[H]:N}),p.byScope)}:typeof A=="string"?{...p.byScope,[A]:N}:p.byScope}),{...h,byName:{...h.byName},byScope:{...h.byScope}})}),f)}),m)}),l),{byName:{},byScope:{}}));return{dark:r,light:n}},En=(e,t)=>{const{content:n,explanation:r}=e,{dark:s,light:a}=t,l=r?.reduce((m,g)=>({...m,...g.scopes.reduce((f,{themeMatches:y})=>({...f,...y.reduce((h,{name:b,scope:p})=>{const x=st({...b==null?{}:a.byName[b],...Array.isArray(p)?p.reduce((H,P)=>({...H,...a.byScope[P]}),{}):typeof p=="string"?a.byScope[p]:{}}),A=st({...b==null?{}:s.byName[b],...Array.isArray(p)?p.reduce((H,P)=>({...H,...s.byScope[P]}),{}):typeof p=="string"?s.byScope[p]:{}}),N={...h,...x},R=Object.keys(A).length>0?{nested:{[i.darkMode]:A}}:{};return{...N,...R}},{})}),{})}),{})??{},d=Object.keys(l).length>0?c("span",l):"span";return n.replace(/\s+/,"")===""||d==null?o("span",{},n):o(d,{},n)},wn=(e,t)=>Ne(o(me,{},o("pre",{},o("code",{},...e.reduce((n,r,s)=>{const a=r.map(d=>En(d,t)),l=s===0?"":`
...
`.replace(/\s+/g," "),vi=c("div",{display:"grid",gridColumn:"1 / -1",gridTemplateColumns:Si,padding:"1rem 0"}),Ie="@media (min-width: 0)",Ci=c("nav",{nested:{[Ie]:{flexFlow:"row",justifyContent:"space-between"}},alignItems:"center",display:"flex",flexFlow:"column",justifyContent:"center"}),ki=c("div",{display:"grid",gridColumn:3,justifyContent:"stretch",textAlign:"center"}),xi=c("div",{nested:{[Ie]:{marginLeft:0,marginRight:"1em"}},margin:"0 auto"}),Ti=c("a",{nested:{[i.darkMode]:{color:"hsl(336deg, 80%, 62%)"}},textDecoration:"none"}),mr=c("ul",{nested:{[Ie]:{marginLeft:"1em",marginRight:0,marginTop:0}},alignItems:"baseline",display:"flex",justifyContent:"center",listStyle:"none",margin:"0.75rem auto 0",padding:0}),gr=c("li",{nested:{"&:first-child":{marginLeft:0},"&:last-child":{marginRight:0}},display:"inline-block",listStyle:"none",margin:"0 0 0 2rem",padding:0}),pr=c("a",{...i.siteHeader.pageLinks,fontSize:"1.125em",fontWeight:300,lineHeight:1,textDecoration:"none",nested:{[i.darkMode]:{...i[i.darkMode].siteHeader.pageLinks},":active":{fontWeight:300},":local-link":{textDecoration:"underline"}}}),Ei=()=>o(vi,{as:"header"},o(ki,null,o(Ci,null,o(xi,null,o(Ti,{href:"/"},o(bi,null))),!1))),wi=c(B,{paddingBottom:"4em"}),Ct=({as:e="main",children:t})=>o(me,null,o(Ei,null),o(wi,{as:e},t)),Be=process.cwd(),kt=e=>e.startsWith("/")?W.resolve(Be,e.replace(/^.*?\/src\//,"./src/").replace(/\.js$/,".tsx")):W.extname(e)==""?W.resolve(Be,"./src/pages/",`${e}.tsx`):e;var ye;(function(e){e.ALL="",e.FIRST="--diff-filter=A"})(ye||(ye={}));var be;(function(e){e.HASH="%H",e.ISO_DATE="%aI"})(be||(be={}));const $i="origin",Mi="main",xt=e=>{const{branch:t=Mi,filter:n=ye.FIRST,format:r,path:s=Be,remote:a=$i}=e,{error:l,stdout:d}=bo.spawnSync("git",["log",n,`--branches=${t}`,`--format=${r}`,`--remotes=${a}`,"--",s]);if(l)throw l;const m=d.toString().trim();return m===""?null:n===ye.FIRST?m:m.split(`
`)},Tt=e=>{const t=kt(e),n=xt({format:be.ISO_DATE,path:t}),r=new Date(n??"");return isNaN(r.getTime())?null:r},Oi=e=>{const t=Ye.readFileSync(e).toString();let n=So.createHash("sha1");return n.update(t),n.digest("hex")},Et=e=>{const t=kt(e);return xt({format:be.HASH,path:t})??Oi(t)},Ai=c(B,{...i.aside,nested:{...i.aside.nested,"&:last-child":{marginBottom:0},"& h1":{fontFamily:"unset",fontSize:"1.2em",lineHeight:1,marginBottom:"0.75rem",scrollMarginTop:"1rem"},"& p":{marginBottom:"0.625rem"},"& p:last-child":{marginBottom:0}},marginBottom:"2rem",paddingBottom:"1rem",paddingTop:"1rem"}),Pi=c("h1",{fontSize:"1em",lineHeight:1,marginBottom:"0.75rem"}),Li=c("div",{fontSize:"0.889em"}),ji=({as:e="section",title:t,...n})=>o(Ai,{as:e,itemprop:"description"},t?o(Pi,null,t):null,o(Li,{...n}));import.meta.env=ce;const Ii=c("h1",{marginBottom:"0.25rem"}),Bi=c(B,{marginBottom:"1rem"}),Ri=({children:e,description:t,descriptionRaw:n,hash:r,stat:{created:s},title:a,topics:l})=>o(V,null,o(vt,null,o(Ue.title,null,a," | Eyelidlessness"),o(Ue.description,null,n)),o(Ct,{as:"article"},o(Bi,null,o(ht,null),o(Le,{hash:r,title:a,topics:l}),o(Ii,null,a),o(ut,{date:s,itemprop:"datePublished"}),o(bt,{link:!1,topics:l})),o(ji,null,t),e)),Ni=e=>{const{description:t,path:n,title:r,topics:s}=e,a=Rn`${Ne(o(V,null,t))}`,l=Et(n),d={created:Tt(n)??Ye.statSync(import.meta.url.replace(/^file:(\/\/)?/,"")).ctime};return{description:t,descriptionRaw:a,hash:l,path:n,stat:d,title:r,topics:s}};export{Le as BlogArt,ht as BlogArtDefs,pi as BlogListing,Ri as BlogPost,vt as Head,Ct as Main,me as StylesProvider,u as Topic,yt as TopicTag,ce as __SNOWPACK_ENV__,Ni as getBlogPostStaticProps,Tt as getInitialCommitDate,Et as getInitialFileHash,Bn as mdx,c as styled};
