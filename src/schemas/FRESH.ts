...
const employmentHistory = array(
	object({
		...
		highlights: optional(array(union([string(), array(string())]))),
		location: optional(
			string({
...
const projects = array(
	object({
		...
		start: optional(
			string({
				description:
					'Date your involvement with project began, in YYYY, YYYY-MM, or YYYY-MM-DD format.',
				format: 'date',
			})
		),
		end: optional(
			string({
				description:
					'Date your involvement with project ended, in YYYY, YYYY-MM, or YYYY-MM-DD format.',
				format: 'date',
			})
		),
		highlights: optional(
			...
			list: array(
				object({
					...
					level: optional(
						string({
							description:
								'A freeform description of your level of mastery with the skill.',
						})
					),
					summary: optional(
						string({
...
const educationHistory = array(
	object({
		title: optional(
			string({
				description:
					'A freeform title for this education stint. Typically, this should be the short name of your degree, certification, or training.',
			})
		),
