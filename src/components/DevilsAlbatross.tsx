...
type DevilsAlbatrossProps<P extends StyleableProps = StyleableProps> = Omit<
	P,
	'as' | 'children'
> & {
...
export const DevilsAlbatross = <P extends StyleableProps>({
	...
	gap,
	...props
}: DevilsAlbatrossProps<P>): ComponentChildren => {
	...
	return <DevilsAlbatrossComponent {...(props as unknown as P)} />;
};
