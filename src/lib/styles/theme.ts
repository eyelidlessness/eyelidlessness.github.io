...
import { DEFAULT_TOPIC, Topic } from '../content/topics.js';
...
const listElements = ['dd', 'dl', 'dt', 'li', 'ol', 'ul'] as const;
...
const firstLastMarginZeroElements = [...headingElements, ...listElements, 'p'];

const fontSizeRangeMinRatio = baseFontSizeRange.minEm / baseFontSizeRange.maxEm;
...
const mainGridColumns = [
	...
	[`${mainGridMaxWidthCh}ch`, `calc(100% - ${mainGridSidePaddingRem * 2}rem)`],
	`${mainGridSidePaddingRem}rem`,
	'1.2fr',
] as const;
...
export const theme = {
	...
	[darkMode]: {
		...
		prose: {
			...
			'--color-prose-decoration': 'hsl(190deg 20% 97% / 55%)',
		},
	...
	prose: {
		...
		'--color-prose-decoration': 'hsl(210deg 12% 5% / 55%)',
